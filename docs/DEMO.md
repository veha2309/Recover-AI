...
5. Open **Evaluation** for paired results and zero unsafe executions.
6. Open **Audit**, verify the hash chain, and export the reproducibility manifest.

## Dynamic extension

Open **Dynamic lab**, generate five cases, plan the top case, submit a promise on another, and advance time. This demonstrates event-driven behavior rather than a precomputed batch result.

All displayed recovery results are deterministic simulation outcomes, not production performance claims.
